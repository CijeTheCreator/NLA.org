...
/***/ "./Html_Templates/Articles_Single_Article_Html.js":
/*!********************************************************!*\
  !*** ./Html_Templates/Articles_Single_Article_Html.js ***!
  \********************************************************/
...
/* harmony export */   articles_single_article_html: () => (/* binding */ articles_single_article_html)
/* harmony export */ });
const articles_single_article_html = `<div class="posts__PostListItem-sc-yqhhz3-1 eSXAug single_articles">
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Html_Templates_Articles_Single_Article_Html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Html_Templates/Articles_Single_Article_Html */ "./Html_Templates/Articles_Single_Article_Html.js");
...
const populate_page = () => {
  const articles_html_template = _Html_Templates_Articles_Single_Article_Html__WEBPACK_IMPORTED_MODULE_0__.articles_single_article_html;
  const articles_html_filled = _Utils_Mock_Data__WEBPACK_IMPORTED_MODULE_1__.Articles.map((el) => {
    let temp_article_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      articles_html_template,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.Articles.single_article.article_abstract,
      el.article_abstract
    );
    temp_article_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      temp_article_html,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.Articles.single_article.article_authors,
      el.article_authors
    );
    temp_article_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      temp_article_html,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.Articles.single_article.article_title,
      el.article_title
    );
    temp_article_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      temp_article_html,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.Articles.single_article.article_publish_date,
      el.article_publish_date
    );
    temp_article_html = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.applyPlaceholder)(
      temp_article_html,
      _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Placeholders.Articles.single_article.article_image_src,
      `${_Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Routes.ArticleImages}${el.article_image_src}`
    );

    return temp_article_html;
  }).join(" ");
  console.log(articles_html_template);
  (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.insertInnerHtml)(_Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Selectors.Articles.articles_container, articles_html_filled);
};

(0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.selectElement)(
  _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Selectors.Articles.NLA_Enugu_State_Chapter_bread_crumbs_Button
).href = _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Routes.Homepage;

populate_page();
const articles = (0,_Utils_General_Utils__WEBPACK_IMPORTED_MODULE_3__.selectElements)(_Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Selectors.Articles.single_articles);
for (let i = 0; i < articles.length; i++) {
  articles[i].href = _Utils_Selectors_And_PlaceHolders__WEBPACK_IMPORTED_MODULE_2__.Routes.Single_Article;
}
